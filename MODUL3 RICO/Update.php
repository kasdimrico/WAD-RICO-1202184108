...
if ($gambar) {
    ...
    $query = "UPDATE event_table SET name='$name', deskripsi='$deskripsi',kategori='$kategori', tanggal='$tanggal',mulai='$mulai', berakhir='$berakhir', tempat='$tempat',harga='$harga', benefit='$benefit' WHERE id = $id";
    $update = mysqli_query($conn, $query);
    header("location:DetailEvent.php?id=$id");
}